...
export default function Hero() {
  ...
  return (
    <div className="relative min-h-screen bg-white flex flex-col w-full selection:bg-purple-200 selection:text-purple-900 overflow-x-hidden font-sans">
      ...
      <header id="navbar" className="w-full bg-[#F3EFFF] border-b border-[#7C3AED]/10 px-6 sm:px-12 py-3.5 sm:py-4">
      ...
      {/* 3. Hero Section */}
      <main id="hero-section" className="flex-1 flex flex-col items-center justify-center text-center px-6 sm:px-12 py-16 sm:py-24 max-w-5xl mx-auto w-full relative z-10">
